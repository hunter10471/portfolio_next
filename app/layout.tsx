...
export const metadata: Metadata = {
  ...
  description:
    "Experienced full stack developer specializing in React, Next.js, and Node.js with 2+ years of experience. View my portfolio of 31+ successful projects with 5-star ratings.",
  keywords: [
    "Rafay",
    "rafay",
    "Rafay Zia",
