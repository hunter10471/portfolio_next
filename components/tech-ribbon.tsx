...
export default function TechRibbon() {
  ...
  return (
    <div className="w-full overflow-hidden bg-muted py-8 dark:bg-muted/30" ref={containerRef}>
      ...
      <div className="relative w-full">
        <motion.div className="flex whitespace-nowrap" animate={controls}>
          ...
          {[...technologies, ...technologies].map((tech, index) => (
            <div key={`${tech.name}-${index}`} className="mx-8 flex flex-col items-center justify-center">
